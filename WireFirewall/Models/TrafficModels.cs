...
namespace HackerFirewall.Models
{
    ...
    public class TrafficEntry : ViewModelBase
    {
        ...
        public ProtocolType Protocol { get => _protocol; set => SetProperty(ref _protocol, value); }

        private PacketDirection _direction;
        public PacketDirection Direction { get => _direction; set => SetProperty(ref _direction, value); }

        private bool _wasBlocked;
        public bool WasBlocked { get => _wasBlocked; set => SetProperty(ref _wasBlocked, value); }

        private uint _dataSize;
        public uint DataSize { get => _dataSize; set => SetProperty(ref _dataSize, value); }

        private string _localIpOnly = "";
        public string LocalIpOnly
        {
            get => _localIpOnly;
            set
            {
                if (SetProperty(ref _localIpOnly, value))
                    IpVersion = !string.IsNullOrEmpty(value) && value.Contains(":") ? "IPv6" : "IPv4";
            }
        }

        private ushort _localPortOnly;
        public ushort LocalPortOnly { get => _localPortOnly; set => SetProperty(ref _localPortOnly, value); }

        private string _remoteIpOnly = "";
        public string RemoteIpOnly { get => _remoteIpOnly; set => SetProperty(ref _remoteIpOnly, value); }

        private ushort _remotePortOnly;
        public ushort RemotePortOnly { get => _remotePortOnly; set => SetProperty(ref _remotePortOnly, value); }

        private byte[] _packetData = Array.Empty<byte>();
        public byte[] PacketData { get => _packetData; set => SetProperty(ref _packetData, value); }

        private string _ipVersion = "IPv4";
        public string IpVersion { get => _ipVersion; set => SetProperty(ref _ipVersion, value); }
        ...
        public string PathLanguage
        {
            get
            {
                try
                {
                    ...
                    if (hasOther) return "";
                    if (hasRussian && hasEnglish) return "";
                    if (hasRussian) return "RUS";
